    ...
    private void ListerReservation(ActionEvent event) {
     ...
     public void sendMailConfirmation(){
      try{
            ...
            String subject = "Celestial suivi de l'Etat de votre Réservation!";
            String messageText = "Bonjour cher client  , "
                    + "votre réservation est "+r.getEtatReservation()+". "
                    + "Merci de suivre l'etat de votre reservation avec nous."
                    + "Cordialemment";
