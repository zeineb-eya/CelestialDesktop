...
public class User {
    ...
    public User(int id, String mail_utilisateur,String nom_utilisateur, String prenom_utilisateur, String adresse_utilisateur, String password, String Numero_utilisateur) {
        this.id = id;
